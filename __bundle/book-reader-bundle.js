...
var require_react_dom_client_development = __commonJS({
  "node_modules/react-dom/cjs/react-dom-client.development.js"(exports) {
    ...
    (function() {
      ...
      HooksDispatcherOnUpdateInDEV.useOptimistic = function(passthrough, reducer2) {
        currentHookNameInDev = "useOptimistic";
        updateHookTypesDev();
      ...
      HooksDispatcherOnRerenderInDEV.useOptimistic = function(passthrough, reducer2) {
        currentHookNameInDev = "useOptimistic";
        updateHookTypesDev();
      ...
      InvalidNestedHooksDispatcherOnUpdateInDEV.useOptimistic = function(passthrough, reducer2) {
        currentHookNameInDev = "useOptimistic";
        warnInvalidHookAccess();
        updateHookTypesDev();
        return updateOptimistic(passthrough, reducer2);
      ...
      InvalidNestedHooksDispatcherOnRerenderInDEV.useOptimistic = function(passthrough, reducer2) {
        currentHookNameInDev = "useOptimistic";
        warnInvalidHookAccess();
        updateHookTypesDev();
        return rerenderOptimistic(passthrough, reducer2);
...
function EbookReader() {
  const toggleFullScreen = (full_screen_ref2) => {
    if (!document.fullscreenElement) {
      full_screen_ref2.current.requestFullscreen().catch((err) => {
        alert(
          `Error attempting to enable fullscreen mode: ${err.message} (${err.name})`
        );
      });
  ...
  const full_screen_ref = (0, import_react2.useRef)(null);
  ...
  return /* @__PURE__ */ import_react.default.createElement("div", { className: "EbookReader" }, /* @__PURE__ */ import_react.default.createElement(LeftPanel, { acc_no, title, author }), /* @__PURE__ */ import_react.default.createElement("div", { className: "EbookReader right-panel", ref: full_screen_ref }, /* @__PURE__ */ import_react.default.createElement(
    Controls,
    {
      page_no: state.page_no,
      prev: () => {
        if (state.page_no > 1) dispatch({ type: "prev" });
      },
      next: () => {
        if (state.page_no < pages.length) dispatch({ type: `next#${pages.length}` });
      },
      handle_zoom_in: () => {
        if (state.zoom < 250) dispatch({ type: "zoom-in" });
      },
      handle_zoom_out: () => {
        if (state.zoom > 60) dispatch({ type: "zoom-out" });
      },
      handle_select_single_page: () => {
        if (state.no_of_pages !== 1) dispatch({ type: "select-page-single" });
      },
      handle_select_double_page: () => {
        if (state.no_of_pages !== 2) dispatch({ type: "select-page-double" });
      },
      change_full_screen: () => toggleFullScreen(full_screen_ref),
      state
    }
  ), /* @__PURE__ */ import_react.default.createElement(BookDisplay, { pages, page_no: state.page_no, layout: state.no_of_pages, zoom: state.zoom, acc_no })));
}
function LeftPanel({ acc_no, title, author }) {
  return /* @__PURE__ */ import_react.default.createElement("div", { className: "EbookReader LeftPanel" }, /* @__PURE__ */ import_react.default.createElement("img", { className: "book-thumbnail", src: `/images/book_reader/covers/${acc_no}.jpg` }), /* @__PURE__ */ import_react.default.createElement("div", { className: "font-title" }, title.replaceAll("#", " ")), /* @__PURE__ */ import_react.default.createElement("div", { className: "font-author" }, "by - ", author.replaceAll("#", " ")), /* @__PURE__ */ import_react.default.createElement("button", { className: "get-details" }, "Get Details"));
}
function Controls(props) {
  var page_no = props.page_no;
  return /* @__PURE__ */ import_react.default.createElement("div", { className: "Controls" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "controls-left" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "btn-grp" }, /* @__PURE__ */ import_react.default.createElement("button", { className: "btn font-controls" }, `Zoom: ${props.state.zoom}%`), "    "), /* @__PURE__ */ import_react.default.createElement("div", { className: "btn-grp" }, /* @__PURE__ */ import_react.default.createElement("button", { className: "btn", onClick: props.handle_zoom_out }, /* @__PURE__ */ import_react.default.createElement("img", { className: "icon", src: "/images/book_reader/icons/zoom-out.png" })), /* @__PURE__ */ import_react.default.createElement("button", { className: "btn", onClick: props.handle_zoom_in }, /* @__PURE__ */ import_react.default.createElement("img", { className: "icon", src: "/images/book_reader/icons/zoom-in.png" })), "  "), /* @__PURE__ */ import_react.default.createElement("div", { className: "btn-grp" }, /* @__PURE__ */ import_react.default.createElement("button", { className: "btn", onClick: props.handle_select_single_page }, /* @__PURE__ */ import_react.default.createElement("img", { className: "icon", src: "/images/book_reader/icons/single-page-layout-fold.png" })), /* @__PURE__ */ import_react.default.createElement("button", { className: "btn", onClick: props.handle_select_double_page }, /* @__PURE__ */ import_react.default.createElement("img", { className: "icon", src: "/images/book_reader/icons/double-page-layout.png" })), "    "), /* @__PURE__ */ import_react.default.createElement("div", { className: "btn-grp" }, /* @__PURE__ */ import_react.default.createElement("button", { className: "btn", onClick: props.change_full_screen }, /* @__PURE__ */ import_react.default.createElement("img", { className: "icon", src: "/images/book_reader/icons/fullscreen.png" })), "   ")), /* @__PURE__ */ import_react.default.createElement("div", { className: "controls-right" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "btn-grp" }, /* @__PURE__ */ import_react.default.createElement("button", { className: "btn font-controls" }, "Page ", props.page_no), "   "), /* @__PURE__ */ import_react.default.createElement("div", { className: "btn-grp" }, /* @__PURE__ */ import_react.default.createElement("button", { className: "btn", onClick: props.prev }, /* @__PURE__ */ import_react.default.createElement("img", { className: "icon", src: "/images/book_reader/icons/prev.png" })), /* @__PURE__ */ import_react.default.createElement("button", { className: "btn", onClick: props.next }, /* @__PURE__ */ import_react.default.createElement("img", { className: "icon", src: "/images/book_reader/icons/next.png" })), "  "), /* @__PURE__ */ import_react.default.createElement("div", { className: "btn-grp" }, /* @__PURE__ */ import_react.default.createElement("button", { className: "btn", disabled: true }, /* @__PURE__ */ import_react.default.createElement("img", { className: "icon", src: "/images/book_reader/icons/download.png" })), /* @__PURE__ */ import_react.default.createElement("button", { className: "btn", disabled: true }, /* @__PURE__ */ import_react.default.createElement("img", { className: "icon", src: "/images/book_reader/icons/print.png" })), "   ")));
}
function BookDisplay({ pages, page_no, layout, zoom, acc_no }) {
  ...
  var display_list = tmp_list.map((p_no) => {
    ...
    if (p_no > pages.length) {
      return /* @__PURE__ */ import_react.default.createElement("img", { key: __key, className: "page", src: "/images/book_reader/blank_page.jpg", style });
    } else return /* @__PURE__ */ import_react.default.createElement("img", { key: __key, className: "page", src: new_url, style });
  });
  return /* @__PURE__ */ import_react.default.createElement("div", { className: "BookDisplay" }, display_list);
}
var ebookReader_default = EbookReader;

// src/index.js
var root = import_client.default.createRoot(document.getElementById("book-reader-root"));
root.render(
  /* @__PURE__ */ import_react3.default.createElement(import_react3.default.StrictMode, null, /* @__PURE__ */ import_react3.default.createElement(ebookReader_default, null))
);
...
react-dom/cjs/react-dom-client.development.js:
   ...
   *)
*/
//# sourceMappingURL=book-reader-bundle.js.map
